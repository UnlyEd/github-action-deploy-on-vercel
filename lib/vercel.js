...
const createAliases = (deploymentUrl, customDeploymentFile, failIfAliasNotLinked, extraAliases) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((vercelConfigFile && fs_1.default.existsSync(vercelConfigFile)) || extraAliases) {
        ...
        if (vercelConfig.alias || extraAliases) {
            ...
            const aliasesToCreate = [...((vercelConfig === null || vercelConfig === void 0 ? void 0 : vercelConfig.alias) || []), ...(extraAliases || [])].filter((alias) => !!alias);
            ...
            core.setOutput('VERCEL_ALIASES_CREATED_COUNT', aliasesCreated === null || aliasesCreated === void 0 ? void 0 : aliasesCreated.length);
            core.exportVariable('VERCEL_ALIASES_CREATED_COUNT', aliasesCreated === null || aliasesCreated === void 0 ? void 0 : aliasesCreated.length);
